...
export default function Landing({dict}) {
    return (
        <section className='landing_page'>
            <div className='slogan_container'>
                <h1 className='slogan_title'>
                    {dict.slogan_title.a}<br /> <span className='highlight_word'>{dict.slogan_title.b} </span>{dict.slogan_title.c}<br />{dict.slogan_title.d}<br />{dict.slogan_title.e}
                </h1>
                <a className='discord_bot_button' href="https://discord.com/oauth2/authorize?client_id=1098780757696192553&permissions=2147535936&scope=bot" target="_blank">
                    <svg width="24" height="24" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="discord_icon">
